                    ...
                    <form>
                        <div class="d-flex flex-wrap gap-4">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <input class="datepicker-here form-control bg--white date-range pe-2" name="date" type="search" value="{{ request()->date }}" placeholder="@lang('Start Date - End Date')" autocomplete="off">
                            </div>
                    ...
                    <div class="table-responsive table-responsive--md">
                        <table class="table custom--table">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td class="text-center text-muted" colspan="7">{{ __($emptyMessage ?? 'No data found') }}</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
